...
public abstract class MixinRenderRegionManager implements INvidiumWorldRendererSetter {
    ...
    @Shadow
    protected abstract void uploadResults(CommandList commandList, RenderRegion region, Collection<ChunkBuildOutput> results);

    @Unique
    private NvidiumWorldRenderer renderer;

    @Redirect(method = "uploadResults*", at = @At(value = "INVOKE", target = "Lnet/caffeinemc/mods/sodium/client/render/chunk/region/RenderRegionManager;uploadResults(Lnet/caffeinemc/mods/sodium/client/gl/device/CommandList;Lnet/caffeinemc/mods/sodium/client/render/chunk/region/RenderRegion;Ljava/util/Collection;)V"))
